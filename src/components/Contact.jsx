...
export default function Contact(){
    ...
    const contacts = [
        {
            id: 1,
            name: 'SVNIT Surat India',
            icon: <FiMapPin />,
        },
        {
            id: 2,
            name: 'ronaksharma7026@gmail.com',
            icon: <FiMail />,
        },
        {
            id: 3,
    ...
    return(
        <div className="w-full mx-auto flex flex-col-reverse lg:flex-row py-5 lg:py-10 bg-[#0d2438]">
        ...
        <div className="leading-loose">
            ...
            >
                ...
                <div className="mt-6">
                    ...
                    <textarea
                        className="w-full px-5 py-2 border border-gray-300 dark:border-primary-dark border-opacity-50  text-black"
                        id="message"
                        name="message"
                        cols="14"
                        rows="6"
